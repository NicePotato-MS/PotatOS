...
enum opt_code
{
  ...
  OPT_march_ = 1173,                         /* -march= */
  OPT_masm_ = 1174,                          /* -masm= */
  OPT_mavx = 1175,                           /* -mavx */
  OPT_mavx2 = 1176,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1177,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1178,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1179,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1180,                  /* -mavx5124vnniw */
  OPT_mavx512bw = 1181,                      /* -mavx512bw */
  OPT_mavx512cd = 1182,                      /* -mavx512cd */
  OPT_mavx512dq = 1183,                      /* -mavx512dq */
  OPT_mavx512er = 1184,                      /* -mavx512er */
  OPT_mavx512f = 1185,                       /* -mavx512f */
  OPT_mavx512ifma = 1186,                    /* -mavx512ifma */
  OPT_mavx512pf = 1187,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1188,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1189,                      /* -mavx512vl */
  OPT_mavx512vpopcntdq = 1190,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1191,                           /* -mbmi */
  ...
  OPT_mindirect_branch_register = 1222,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1223,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1224,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1225,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1226, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1227,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1228,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1229,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1230,                /* -mlong-double-80 */
  OPT_mlwp = 1231,                           /* -mlwp */
  OPT_mlzcnt = 1232,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1233,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1234,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1235,                  /* -mmitigate-rop */
  OPT_mmmx = 1236,                           /* -mmmx */
  OPT_mmovbe = 1237,                         /* -mmovbe */
  OPT_mmpx = 1238,                           /* -mmpx */
  OPT_mms_bitfields = 1239,                  /* -mms-bitfields */
  OPT_mmwaitx = 1240,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1241,            /* -mno-align-stringops */
  OPT_mno_default = 1242,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1243,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1244,                  /* -mno-push-args */
  OPT_mno_red_zone = 1245,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1246,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1247,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1248,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1249,                          /* -mpc32 */
  OPT_mpc64 = 1250,                          /* -mpc64 */
  OPT_mpc80 = 1251,                          /* -mpc80 */
  OPT_mpclmul = 1252,                        /* -mpclmul */
  OPT_mpcommit = 1253,                       /* -mpcommit */
  OPT_mpku = 1254,                           /* -mpku */
  OPT_mpopcnt = 1255,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1256,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1257,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1258,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1259,                        /* -mprfchw */
  OPT_mpush_args = 1260,                     /* -mpush-args */
  OPT_mrdpid = 1261,                         /* -mrdpid */
  OPT_mrdrnd = 1262,                         /* -mrdrnd */
  OPT_mrdseed = 1263,                        /* -mrdseed */
  OPT_mrecip = 1264,                         /* -mrecip */
  OPT_mrecip_ = 1265,                        /* -mrecip= */
  OPT_mrecord_mcount = 1266,                 /* -mrecord-mcount */
  OPT_mred_zone = 1267,                      /* -mred-zone */
  OPT_mregparm_ = 1268,                      /* -mregparm= */
  OPT_mrtd = 1269,                           /* -mrtd */
  OPT_mrtm = 1270,                           /* -mrtm */
  OPT_msahf = 1271,                          /* -msahf */
  OPT_msgx = 1272,                           /* -msgx */
  OPT_msha = 1273,                           /* -msha */
  OPT_mskip_rax_setup = 1274,                /* -mskip-rax-setup */
  OPT_msoft_float = 1275,                    /* -msoft-float */
  OPT_msse = 1276,                           /* -msse */
  OPT_msse2 = 1277,                          /* -msse2 */
  OPT_msse2avx = 1278,                       /* -msse2avx */
  OPT_msse3 = 1279,                          /* -msse3 */
  OPT_msse4 = 1280,                          /* -msse4 */
  OPT_msse4_1 = 1281,                        /* -msse4.1 */
  OPT_msse4_2 = 1282,                        /* -msse4.2 */
  OPT_msse4a = 1283,                         /* -msse4a */
  /* OPT_msse5 = 1284, */                    /* -msse5 */
  OPT_msseregparm = 1285,                    /* -msseregparm */
  OPT_mssse3 = 1286,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1287,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1288,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1289,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1290,            /* -mstringop-strategy= */
  OPT_mstv = 1291,                           /* -mstv */
  OPT_mtbm = 1292,                           /* -mtbm */
  OPT_mtls_dialect_ = 1293,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1294,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1295,                    /* -mtune-ctrl= */
  ...
  OPT_pie = 1322,                            /* -pie */
  OPT_pipe = 1323,                           /* -pipe */
  OPT_print_file_name_ = 1324,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1325,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1326,          /* -print-multi-directory */
  OPT_print_multi_lib = 1327,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1328,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1329,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1330,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1331,               /* -print-prog-name= */
  OPT_print_search_dirs = 1332,              /* -print-search-dirs */
  OPT_print_sysroot = 1333,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1334,   /* -print-sysroot-headers-suffix */
